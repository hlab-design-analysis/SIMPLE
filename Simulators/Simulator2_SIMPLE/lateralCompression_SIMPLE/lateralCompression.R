...
########################################################################################
#
# This script compress the flow to avoid the instance in which fishes are mixed with 
# empty spaces at the end (on the left side) of the flowed flow. 
# The compression is done if the parameter "lateralCompression" is set to 1 and its 
# type is governed by "typeLateralCompression". The latter can be 
# "sigmoid", which pushes the fishes to the right, if the right cell is empty,
# originating a sigmoid shape or "sharp", reassinging fishes to cell to obtain the 
# sharpest shape possible. 
# 
#
########################################################################################
#
...
if(lateralCompression == 1 & typeLateralCompression == "sharp"){
...
# Save the results by updating the flow file
