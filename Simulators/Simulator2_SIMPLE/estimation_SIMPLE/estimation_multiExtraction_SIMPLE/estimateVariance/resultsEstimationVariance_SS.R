...
# For SRS
df_varianceComparison_SRS_multiExtraction_summary <- df_varianceComparison_SRS_multiExtraction %>% # Extract the summary of the variance results
  t() %>% 
  as.data.frame() %>% 
  rowwise() %>% 
  mutate(
...
df_varianceComparison_SRS_multiExtraction_summary <- df_varianceComparison_SRS_multiExtraction_summary %>% # Extract the name of the estimators having minimum value at a certain replica
  as.data.frame() %>% 
...
table_df_varianceComparison_SRS_multiExtraction_summary <- kable(df_varianceComparison_SRS_multiExtraction_summary) %>% # Save as image
...
df_varianceComparison_SRS_multiExtraction_summary_leaderboard <- df_varianceComparison_SRS_multiExtraction_summary %>% # Create a table reporting the score of variance estimators 
...
df_varianceComparison_FINAL_multiExtraction_summary_leaderboard <- rbind(
  df_varianceComparison_SRS_multiExtraction_summary_leaderboard, 
  df_varianceComparison_SS_multiExtraction_summary_leaderboard
) %>% 
  arrange(
    desc(n)
  )
